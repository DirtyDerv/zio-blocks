...
addCommandAlias(
  "testJVM",
  "typeidJVM/test; chunkJVM/test; combinatorsJVM/test; schemaJVM/test; streamsJVM/test; schema-toonJVM/test; schema-messagepackJVM/test; schema-avro/test; schema-thrift/test; schema-bson/test; schema-xmlJVM/test; contextJVM/test; scopeJVM/test; mediatypeJVM/test"
)
addCommandAlias(
  "testJS",
  "typeidJS/test; chunkJS/test; combinatorsJS/test; schemaJS/test; streamsJS/test; schema-toonJS/test; schema-messagepackJS/test; schema-xmlJS/test; contextJS/test; scopeJS/test; mediatypeJS/test"
)

addCommandAlias(
  "docJVM",
  "typeidJVM/doc; chunkJVM/doc; combinatorsJVM/doc; schemaJVM/doc; streamsJVM/doc; schema-toonJVM/doc; schema-messagepackJVM/doc; schema-avro/doc; schema-thrift/doc; schema-bson/doc; schema-xmlJVM/doc; contextJVM/doc; scopeJVM/doc; mediatypeJVM/doc"
)
addCommandAlias(
  "docJS",
  "typeidJS/doc; chunkJS/doc; combinatorsJS/doc; schemaJS/doc; streamsJS/doc; schema-toonJS/doc; schema-messagepackJS/doc; schema-xmlJS/doc; contextJS/doc; scopeJS/doc; mediatypeJS/doc"
)
